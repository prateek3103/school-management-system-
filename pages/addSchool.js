...
export default function AddSchool() {
  ...
  const {
    ...
    formState: { errors },
    reset,
    setValue // We'll use this to clear the file input
  } = useForm();

  // This is the new, more reliable submission logic
  const onSubmit = async () => {
    setLoading(true);
    
    // Create FormData directly from the form element using the ref.
    // This is the most reliable way to ensure files are included.
    ...
    // No finally block to set loading to false, as we navigate away on success
  };
  ...
  const removeImage = () => {
    setImagePreview('');
    // Use setValue from react-hook-form to clear the file input
    setValue('image', null); 
  }
