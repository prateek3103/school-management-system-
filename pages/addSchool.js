...
export default function AddSchool() {
  ...
  const onSubmit = async () => {
    ...
    // We create FormData directly from the form element using the ref.
    // This is the most reliable way to include files.
    ...
    // We don't set loading to false here because we navigate away on success
  };
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12 animate-slide-up">
          ...
          <div className="animate-float mb-8">
             <div className="w-20 h-20 ..."><GraduationCap className="h-10 w-10 ..." /></div>
          </div>
          <h1 className="text-5xl ...">Add New School</h1>
          <p className="text-xl ...">Fill in the details below...</p>
        </div>

        <div className="card-elevated p-8 md:p-12 ...">
          {/* Attach the ref to the form element here */}
          <form ref={formRef} onSubmit={handleSubmit(onSubmit)} className="space-y-8">
            <div>
              <label>School Name *</label>
              {/* IMPORTANT: Make sure the `name` attribute from `register` matches the FormData key */}
              <input type="text" {...register('name', { required: 'School name is required' })} />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
               <div>
                  ...
                  <input type="tel" {...register('contact', { required: 'Contact is required' })} />
                ...
                {imagePreview ? (
                  <div>
                    ...
                    <button type="button" onClick={() => {
                        setImagePreview('');
                        reset({ image: null }); // Also reset the form field value
                    }}>Remove Image</button>
                  </div>
                ) : (
                  <>
                    ...
                    <label>
                      ...
                      {/* The `name` here is critical for FormData */}
            ...
            <div className="flex ... gap-4 pt-8">
              <button type="button" onClick={() => router.push('/showSchools')}>Cancel</button>
