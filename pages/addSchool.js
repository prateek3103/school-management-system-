...
export default function AddSchool() {
  ...
  const [selectedFile, setSelectedFile] = useState(null); // Track selected file separately
...
//       // THIS IS THE FIX: Correctly check for the file in the `data` object
...
//       <div className="max-w-4xl mx-auto">
//         <div className="text-center mb-12 animate-slide-up">
//           <button onClick={() => router.back()} className="inline-flex items-center text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-100 mb-8 transition-colors group">
//             <ArrowLeft className="h-5 w-5 mr-2 group-hover:-translate-x-1 transition-transform duration-300" />
//             Go Back
//           </button>
//           <div className="animate-float mb-8">
//              <div className="w-20 h-20 bg-slate-900 dark:bg-slate-100 rounded-2xl flex items-center justify-center mx-auto shadow-2xl"><GraduationCap className="h-10 w-10 text-white dark:text-slate-900" /></div>
//           </div>
//           <h1 className="text-5xl md:text-6xl font-bold text-slate-900 dark:text-slate-100 mb-6">Add New School</h1>
//           <p className="text-xl text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">Fill in the details below to add a new school to your directory</p>
//         </div>

//         <div className="card-elevated p-8 md:p-12 animate-slide-up" style={{ animationDelay: '0.2s' }}>
//           <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
//             {/* The file input MUST be registered with react-hook-form */}
//             <input
//               type="file"
//               {...register('image')}
//               onChange={handleImageChange}
