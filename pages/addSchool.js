...
// import { School, Upload, Save, ArrowLeft, CheckCircle } from 'lucide-react';
...
//           <p className="text-xl">School has been added successfully</p>
//         </div>
//       </div>
//     );
//   }
...
//   return (
//     <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8 gradient-bg hero-pattern">
...
//               <School className="h-20 w-20 mx-auto text-white" />
...
//             Fill in the details below to add a new school to our comprehensive directory
//           </p>
//         </div>

//         {/* Form Card */}
//         <div className="card-modern p-8 md:p-12 animate-slide-up" style={{ animationDelay: '0.2s' }}>
...
//                 <div className="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-2xl p-8 text-center hover:border-blue-500 transition-colors group">
//                   {imagePreview ? (
...
//                 className="flex-1 px-8 py-4 border-2 border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-700 font-semibold transition-all duration-300"
//               >
//                 Cancel
//               </button>
